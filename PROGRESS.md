...
| 8 | 5 | The Defense | **Done**: approved by the instructor 2026-09-26; day deck `lectures/kr-session-08.html`, 8 slides, 180 minutes, defense only; `module-08-defense/DEFENSE-DAY.md` and `scoring-sheet.html` | The starter repository https://github.com/ahmabboud/kr-team-template (a GitHub template; verified end to end with Docker on the Mac, CI green) |

All built decks carry the automatic glossary. Sessions 1 to 5 and the Session 6 draft use
`lu-flow` diagrams. `index.html` has cards for Sessions 1 to 8.
...
See `REPLAN-STATE.md` "Where to continue". Sessions 1 to 7 are rebuilt and approved; Session 8 is next. Then: the Ontop run for Session 5 on the Mac, then Sessions 7 and 8
