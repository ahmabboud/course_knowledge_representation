...
# ---------------------------------------------------------------- Glossary
GLOSS = [
    ("Ontology", "Kinds of things and how they relate, machine readable."),
    ("Class · individual", "A kind of thing · one thing."),
    ("TBox · ABox", "The rules · the data."),
    ("some · only", "At least one link · every link, if any."),
    ("Domain · range", "What subject and object are inferred to be."),
    ("Defined class", "EquivalentTo: the reasoner fills it."),
    ("Reasoner", "Works out every fact that follows."),
    ("Unsatisfiable", "Can never have a member; red in Protégé."),
    ("Inconsistent", "The ontology contradicts itself."),
    ("Justification", "The axioms behind an inference."),
    ("BFO · SCRO", "The upper ontology · the one we extend."),
    ("Continuant · occurrent", "A thing that lasts · a happening."),
    ("OWL profile", "A part of OWL that keeps reasoning fast."),
    ("ELK · HermiT", "Fast, partial · complete, slower."),
]
half = (len(GLOSS) + 1) // 2
