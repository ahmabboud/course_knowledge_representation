...
IGNORE = set("LU MSC ID OK PM AM UTC TODO HTML CSS JS PDF PNG URL API UI TL DR KR IT USA UK EU Q1 Q2 Q3 Q4 I II III IV WH BY EL QL RL DL FOL ODC PDDL EPCIS-SHACL".split())
